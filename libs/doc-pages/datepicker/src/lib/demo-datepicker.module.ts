...
import { defineLocale, LocaleData } from '@iqualify/ngx-bootstrap/chronos';
import { BsDatepickerModule, DatepickerModule } from '@iqualify/ngx-bootstrap/datepicker';
...
import {
  ...
  zhCnLocale, ukLocale
} from '@iqualify/ngx-bootstrap/locale';
